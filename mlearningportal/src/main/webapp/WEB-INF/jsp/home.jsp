					...
					<div _ngcontent-c4=""
						...
						<div _ngcontent-c4="" class="admin-up">
							...
							<div _ngcontent-c4="" class="data">
								<p _ngcontent-c4="">Total Courses</p>
								<h4 _ngcontent-c4="">
				...
				<div _ngcontent-c4="" class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
					<div _ngcontent-c4=""
						...
						<div _ngcontent-c4="" class="admin-up">
							...
							<div _ngcontent-c4="" class="data">
								<p _ngcontent-c4="">Total Assigned Courses </p>
								<h4 _ngcontent-c4="">
				...
				<div _ngcontent-c4="" class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
					<div _ngcontent-c4=""
						...
						<div _ngcontent-c4="" class="admin-up">
							...
							<div _ngcontent-c4="" class="data">
								<p _ngcontent-c4="">Total Employee Completed</p>
								<h4 _ngcontent-c4="">
				...
				<div _ngcontent-c4="" class="col-xl-3 col-lg-3 col-md-3 col-sm-6 m-b-3">
					<div _ngcontent-c4=""
						...
						<div _ngcontent-c4="" class="admin-up">
							...
							<div _ngcontent-c4="" class="data">
								<p _ngcontent-c4="">Total Pending</p>
								<h4 _ngcontent-c4="">
                	...
                	<div class="box box-widget widget-user-2">
                        ...
                        <div class="box-footer no-padding">
                        	<ul class="nav nav-stacked">
                                ...
                                <li data-toggle="collapse" data-target="#demo1"><a >No of Employee not Attempt  <span class="pull-right badge bg-yellow">${userDashboardLogs.totalIncompleteModulesNonComplianceCount+userDashboardLogs.totalIncompleteModulesComplianceCount }</span></a>
                                ...
                                <li data-toggle="collapse" data-target="#demo2"><a>Total Employee Completed <span class="pull-right badge bg-green">${userDashboardLogs.totalCompleteModulesNonComplianceCount+userDashboardLogs.totalCompleteModulesComplianceCount }</span></a>
                                ...
                                <li data-toggle="collapse" data-target="#demo3"><a >Total Employee passed <span class="pull-right badge bg-green">${userDashboardLogs.totalPassNonComplianceCount+userDashboardLogs.totalPassComplianceCount }</span></a>
                                ...
                                <li data-toggle="collapse" data-target="#demo4"><a >Total Employee Failed <span class="pull-right badge bg-red">${userDashboardLogs.totalFailNonComplianceCount+userDashboardLogs.totalFailComplianceCount }</span></a>
                                ...
                                <li data-toggle="collapse" data-target="#demo5"><a >Total Employee pending (compliance) <span class="pull-right badge bg-red">${userDashboardLogs.totalCourseModulePendingCompliance }</span></a>
								...
								<a href="user_modules_detail?courseModuleId=${val.id}" class="btn-loaderClass">   <li>${val.name }</li></a>
                                  ...
                                  <li data-toggle="collapse" data-target="#demo6"><a >Total Employee pending (non-compliance) <span class="pull-right badge bg-red">${userDashboardLogs.totalCourseModulePendingNonCompliance }</span></a>
